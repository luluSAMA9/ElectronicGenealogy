...
namespace 电子族谱管理系统
{
    public partial class 族谱信息 : Form
    {
        ...
        private void 族谱信息_Load(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT TBL_ID ,ID,name,surname,instrouction,date from TBL_family_tree where TBL_ID" + TBL_ID2 + "'";//查询数据库语言 ，选择的SQL语句
